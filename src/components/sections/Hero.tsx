    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-6xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100/80 to-blue-200/80 px-6 py-3 rounded-full text-royal-blue font-semibold text-sm mb-8 animate-fade-in-up hover:scale-105 transition-all duration-300 backdrop-blur-sm">
          ...
          <div className="mt-20 animate-fade-in-up-delay-3">
            ...
            <div className="flex justify-center items-center gap-8 opacity-60">
              <div className="w-28 h-14 bg-white/80 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 border border-blue-200/50">
                <span className="text-sm font-bold text-royal-blue">مدرسة</span>
              </div>
              <div className="w-28 h-14 bg-white/80 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 border border-blue-200/50">
                <span className="text-sm font-bold text-royal-blue">جامعة</span>
              </div>
              <div className="w-28 h-14 bg-white/80 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 border border-blue-200/50">
                <span className="text-sm font-bold text-royal-blue">معهد</span>
              </div>
            </div>
          </div>
        </div>
