        ...
        <div className="pt-24 pb-16 px-4">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="text-center space-y-4">
              <Button 
                onClick={resetTest}
                className="bg-gradient-to-r from-blue-600 to-amber-600 hover:from-blue-700 hover:to-amber-700 text-white px-8 py-3 rounded-full text-lg font-semibold mr-4"
              >
